  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-900 text-white p-6 text-center">
      ...
      <div className="space-y-4 w-full max-w-xs">
        <button onClick={() => cambiarEscena('Creditos')} className="w-full py-3 bg-gray-700 hover:bg-gray-600 rounded font-pixel text-lg transition-colors">Creditos</button>
      </div>
